...
CHUNKS = [
  ...
  {"id":41,"lang":"de","title":"Förderer & Kooperationen","text":"Es gibt zwei Wege, OpenMycoNet als Unternehmen oder Organisation zu unterstützen. Als gewerblicher Förderer zahlt man einen frei wählbaren Jahresbeitrag (mindestens 50 €) und erscheint dafür mit Logo, Name, Kurzbeschreibung und Website-Link sichtbar auf der Fördererseite. Die Zahlung läuft über PayPal; nach erfolgreicher Zahlung wird der Eintrag innerhalb weniger Minuten automatisch freigeschaltet, eine Rechnung wird per E-Mail und als Download bereitgestellt. Als Kooperationspartner beteiligt man sich ohne Geld — stattdessen auf Basis einer Gegenleistung wie Reichweite, Fachwissen, Infrastruktur oder technische Unterstützung. Kooperationsanfragen werden nicht automatisch freigeschaltet, sondern von OpenMycoNet persönlich geprüft, bevor der Eintrag veröffentlicht wird — das dauert meist wenige Tage. Beide Formen sind auf der Fördererseite gleichberechtigt sichtbar, ohne optische Höherstufung der einen gegenüber der anderen. Bewerben kann man sich unter openmyconet.de/foerderer.html über die dortigen Formulare für 'Förderer werden' bzw. 'Kooperation anfragen'."},
  ...
  {"id":43,"lang":"en","title":"Supporters & Cooperations","text":"There are two ways for companies and organisations to support OpenMycoNet. As a commercial supporter you pay a freely chosen annual contribution (minimum €50) and in return appear with logo, name, short description and website link on the supporters page. Payment is handled via PayPal; after successful payment the listing is activated automatically within minutes, and an invoice is provided by email and as a download. As a cooperation partner you contribute without money — instead based on reciprocal value such as reach, expertise, infrastructure or technical support. Cooperation requests are not activated automatically; OpenMycoNet reviews them personally before publishing, which usually takes a few days. Both forms are shown on the supporters page on equal footing, with no visual upgrade of one over the other. You can apply at openmyconet.de/foerderer.html via the 'Become a supporter' and 'Request cooperation' forms."},
  ...
  {"id":45,"lang":"nl","title":"Sponsors & samenwerkingen","text":"Er zijn twee manieren waarop bedrijven en organisaties OpenMycoNet kunnen steunen. Als zakelijke sponsor betaalt u een vrij te kiezen jaarlijkse bijdrage (minimaal €50) en verschijnt u daarvoor met logo, naam, korte beschrijving en websitelink op de sponsorspagina. De betaling verloopt via PayPal; na succesvolle betaling wordt de vermelding binnen enkele minuten automatisch geactiveerd, en ontvangt u een factuur per e-mail en als download. Als samenwerkingspartner draagt u bij zonder geld — in plaats daarvan op basis van een tegenprestatie zoals bereik, expertise, infrastructuur of technische ondersteuning. Samenwerkingsaanvragen worden niet automatisch geactiveerd; OpenMycoNet beoordeelt ze persoonlijk voordat ze worden gepubliceerd, meestal binnen enkele dagen. Beide vormen worden gelijkwaardig getoond op de sponsorspagina. Aanmelden kan via openmyconet.de/foerderer.html met de formulieren 'Zakelijke sponsor worden' en 'Samenwerking aanvragen'."},
  ...
  {"id":47,"lang":"fr","title":"Partenaires & coopérations","text":"Il existe deux façons pour les entreprises et organisations de soutenir OpenMycoNet. En tant que partenaire commercial, vous versez une cotisation annuelle librement choisie (minimum 50 €) et apparaissez en retour avec logo, nom, courte description et lien vers votre site sur la page des partenaires. Le paiement se fait via PayPal ; après paiement réussi, l'annonce est activée automatiquement en quelques minutes, et une facture est fournie par e-mail et en téléchargement. En tant que partenaire de coopération, vous contribuez sans argent — sur la base d'une contrepartie telle que le rayonnement, le savoir-faire, l'infrastructure ou le soutien technique. Les demandes de coopération ne sont pas activées automatiquement ; OpenMycoNet les examine personnellement avant publication, ce qui prend généralement quelques jours. Les deux formes sont présentées à égalité sur la page des partenaires. On peut postuler sur openmyconet.de/foerderer.html via les formulaires 'Devenir partenaire' et 'Demander une coopération'."},
  ...
  {"id":49,"lang":"es","title":"Patrocinadores & cooperaciones","text":"Existen dos formas de que empresas y organizaciones apoyen a OpenMycoNet. Como patrocinador comercial, se paga una cuota anual de libre elección (mínimo 50 €) y a cambio se aparece con logotipo, nombre, breve descripción y enlace al sitio web en la página de patrocinadores. El pago se realiza mediante PayPal; tras un pago exitoso, la entrada se activa automáticamente en minutos, y se proporciona una factura por correo electrónico y como descarga. Como socio de cooperación, se contribuye sin dinero — en base a una contraprestación como alcance, conocimientos, infraestructura o apoyo técnico. Las solicitudes de cooperación no se activan automáticamente; OpenMycoNet las revisa personalmente antes de publicarlas, lo que suele tardar unos días. Ambas formas se muestran en igualdad de condiciones en la página de patrocinadores. Puede solicitarse en openmyconet.de/foerderer.html mediante los formularios 'Convertirse en patrocinador' y 'Solicitar cooperación'."},
