...
def _sqlite_pragmas(dbapi_connection, connection_record):
    ...
    extensions wird als Modul-Singleton genau einmal importiert. Der Guard unten
    laesst alles ausser echten sqlite3-Verbindungen durch (auf Postgres waere
    `PRAGMA ...` ein Syntaxfehler).
