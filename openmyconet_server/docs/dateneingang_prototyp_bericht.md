...
- CI: Ein früher Push (Lauf 174) war im Job `backend` rot, weil Bandit die SQL-f-Strings bemängelte. Behoben im Commit „SQL mit Zielschema über einen Helfer“. Den Ausgang der späteren CI-Läufe bitte in GitHub prüfen.
