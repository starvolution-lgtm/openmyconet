...
FLOW_SVGS = [
    ...
    '<svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="14" cy="14" r="10" stroke="#3a9e5a" stroke-width="1.5" fill="rgba(0,0,0,0.35)"/><path d="M10 14 L13 17 L18 11" stroke="#6ee87e" stroke-width="1.6" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>'
]
